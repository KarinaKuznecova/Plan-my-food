...
import static app.constants.Colors.mainMenuBgColor;

public class MainScreen implements AppScreen {

    List<Component> components = new ArrayList<>();

    public MainScreen(MenuComponent menuComponent) {
    ...
    public void render(App app, RenderHandler renderHandler, Graphics2D graphics2D) {
        renderHandler.renderBackground(graphics2D, mainMenuBgColor);
        for (Component component : components) {
